...
module CypressValidationUtility
  module Validate
    ...
    CMS_EP_CAT1_SCHEMATRON_2016 = 'resources/schematron/cat1/PQRS CMS 2016 QRDA Category I v2.3.sch'.freeze
    CMS_EH_CAT1_SCHEMATRON_2016 = 'resources/schematron/cat1/CMS 2016 QRDA Category 1 - HQR v2.3.sch'.freeze
    CMS_EH_CAT1_SCHEMATRON_2017 = 'resources/schematron/cat1/EH CMS 2017 QRDA Category I.sch'.freeze
    CMS_EP_CAT3_SCHEMATRON_2016 = 'resources/schematron/cat3/EP CMS 2016 QRDA Category III v2.2.sch'.freeze
    CMS_EC_CAT3_SCHEMATRON_2017 = 'resources/schematron/cat3/EC CMS 2017 QRDA Category III v0.1.sch'.freeze
