...
class UploadsControllerTest < ActionController::TestCase
  ...
  setup do
    ...
    BUNDLES["2015"] ||= HealthDataStandards::CQM::Bundle.find_by(version: "2.6.0")
  ...
  test "upload single xml with errors" do
    ...
    assert( response_body.include?("79 errors found") , "Reponse for XML with errors does not include \"79 errors found\"" )
